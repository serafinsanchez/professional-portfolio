...
**Without:** When you paste this directly into Miro, you get one big text block.

**With:** After copying the text and pressing CMD+G, when you paste into Miro, you'll see a prompt asking how you want to paste the data. Select "Paste data as separate sticky notes" and watch as each line becomes its own individual sticky note:

![Miro paste prompt showing options to paste as separate sticky notes](/images/blog/paste-as.png)



Each item becomes an individual sticky note, no more manual creation going line by line!
...
I'm considering adding text formatting preservation and custom sticky note colors. Have ideas or feedback? [Get in touch](/contact).
