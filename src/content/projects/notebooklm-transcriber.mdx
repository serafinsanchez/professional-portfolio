export const meta = {
  title: 'NotebookLM Multi-Language Transcriber',
  ...
  repo: 'https://github.com/serafinsanchez/notebooklm-transcribe',
  demo: '',
...
I built NotebookLM Multi-Language Transcriber to make audio transcription and translation accessible to a global audience. Designed for users who need accurate, multi-speaker transcriptions in a variety of languages, my app streamlines the process of converting audio files into readable, downloadable text and subtitle formats, with optional translation to any language supported by Google Translate.

## Project Overview

This project democratizes access to high-quality, multi-language transcription and translation, empowering users worldwide to convert audio into actionable text and subtitles. It is especially valuable for researchers, journalists, educators, and global teams who need fast, accurate, and language-inclusive transcription without technical barriers or complex setup.
...
1. **Upload Audio:** User selects and uploads an audio file through drag-and-drop interface
2. **Select Source Language:** User chooses the language spoken in the audio from dropdown
3. **Transcription:** The app transcribes the audio, displaying a sample of the result
4. **Speaker Naming:** User optionally assigns custom names to detected speakers
5. **View Full Transcript:** User generates and reviews the complete transcript
6. **Translate (Optional):** User selects a target language and translates the transcript
7. **Download:** User downloads transcript and/or subtitles in preferred formats
8. **Session Reset:** User can start a new session at any time
...
- **International Data Protection Standards:** Documentation emphasizes compliance requirements
- **Local Processing:** Transcription metadata processed locally where possible
- **Secure File Handling:** Industry-standard temporary file management
- **API Security:** Proper error handling and secure API communication
...
### Frontend/Interface
- **Streamlit** for rapid web app development and deployment
- **Python** for all application logic and data processing
- **Custom CSS** for enhanced styling and user experience

### Backend/APIs
- **AssemblyAI** for advanced audio transcription with speaker diarization
- **Google Cloud Translate** for comprehensive translation services
- **python-dotenv** for secure environment variable management
- **Temporary File Libraries** for secure file handling

### Development Tools
- **Requirements.txt** for dependency management
- **Local Environment Setup** for development and testing
- **Manual Testing** workflows for quality assurance
